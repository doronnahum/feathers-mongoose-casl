...
module.exports = {
  ...
  hooks: {
    ...
    returnUserOnLogin: () => {
      console.error('returnUserOnLogin is deprecated, from Feathers v4 @feathersjs/authentication will do this for us');
      return async () => {
  ...
  // NEW from version 2.1.0
  registerNewModel: require('./src/utils/registerNewModel'), // joigoose wrapper - convert joi to mongoose schema
  registerValidator: require('./src/utils/registerNewModel').setJoi,
  //
  // createModelFromJoi - better to use registerNewModel from version 2.1.0
