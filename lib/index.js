...
module.exports = {
  ...
  hooks: {
    ...
    protectFile: require('./src/hooks/protectFile'), // Protect s3 files
    returnResultWithSignUrl: require('./src/hooks/protectFile/returnResultWithSignUrl'), // returnResultWithSignUrl - send results to client with sign url
    protectedFileServerUrlPrefix: require('./src/hooks/protectedFileServerUrlPrefix'), // add host before the /get-file/files-AEid3493j///
  ...
  createUploadMiddleware: require('./src/utils/createUploadMiddleware'),
  // helpers
