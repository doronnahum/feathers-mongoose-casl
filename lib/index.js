...
module.exports = {
  ...
  hooks: {
    ...
    protectedFileServerUrlPrefix: require('./hooks/protectedFileServerUrlPrefix'), // add host before the /get-file/files-AEid3493j///
    authenticate: require('./hooks/authenticate'), // authenticate check
  },
  // Services
  services,
  ...
  callingParamsPersistUser: require('./utils/helpers').callingParamsPersistUser,
};