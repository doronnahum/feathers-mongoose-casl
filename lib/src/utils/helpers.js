...
const callingParamsPersistUserKey = Symbol.for('callingParamsPersistUserKey')
const callingParamsPersistUser = function(hook, query){
  return {
    query,
    [callingParamsPersistUserKey]: {
...
const getPersistUser = function(hook){
  return hook.params && hook.params[callingParamsPersistUserKey];
}
