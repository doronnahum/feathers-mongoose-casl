...
const beforeRead = async function (hook) {
   ...
   * --------------------------------------------------------------------
   */
  const populate = hook.params.query && hook.params.query.$populate;
  if (populate) {
   ...
   */
  const select = hook.params.query && hook.params.query.$select;
  ...
  if (select) {
    hook.params.query = hook.params.query || {};
    hook.params.query.$select = hook.params.query.$select || [];
