...
// const addAuthenticationExampleToSwaggerDocs = hooks.addAuthenticationExampleToSwaggerDocs;
  ...
  app.service('authentication').hooks({
    before: {
      create: [
        ...
        applyIsVerifiedEmail ? verifyHooks.isVerified() : debug('Allow un verify email to login')
      ],
      remove: [
        authentication.hooks.authenticate(config.strategies),
      ]
