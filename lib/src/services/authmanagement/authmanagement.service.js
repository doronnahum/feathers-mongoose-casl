...
const authmanagementSwaggerSchema = require('../../utils/authmanagementSwaggerSchema');
...
module.exports = function (app) {
  ...
  if(app.docs && app.docs.paths['/authManagement']){
    ...
    app.docs.paths['/authManagement'].post.parameters[0].schema = authmanagementSwaggerSchema;
  }
