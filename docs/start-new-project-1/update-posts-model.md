...
{% code-tabs %}
{% code-tabs-item title="posts.class.js " %}
```javascript
...
{% code-tabs-item title="posts.hooks.js" %}
```javascript
...
{% code-tabs-item title="posts.model.js" %}
```javascript
...
{% code-tabs-item title="posts.service.js " %}
```javascript
...
{% code-tabs-item title="posts.validators.js " %}
```javascript
